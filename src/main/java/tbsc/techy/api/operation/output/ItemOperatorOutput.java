 ...
 */
public class ItemOperatorOutput implements IOperatorOutput {
    ...
    /**
     * Start defining an item output.
     * @param parentBuilder The builder this output was created from
     */
    public ItemOperatorOutput(OperatorBuilder parentBuilder) {
        this.parentBuilder = parentBuilder;
    }

    public ItemOperatorOutput setSlotID(int slotID) {
        this.slotID = slotID;
        return this;
    }
