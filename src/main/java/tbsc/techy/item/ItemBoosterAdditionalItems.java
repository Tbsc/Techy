...
public class ItemBoosterAdditionalItems extends ItemBoosterBase {
    ...
    public static final String IDENTIFIER = "itemBoosterBonus";

    @RegisterInstance(identifier = IDENTIFIER, registerClass = ItemBoosterAdditionalItems.class)
    public static ItemBoosterAdditionalItems instance;
