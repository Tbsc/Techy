 ...
 */
public class PipeEnergyBakedModel implements IBakedModel {

    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Techy.MODID + ":blockPipeEnergy");

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public PipeEnergyBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Techy.MODID, "blocks/pipeEnergyTexture"));
    }
    ...
    public List<BakedQuad> getQuads(IBlockState state, EnumFacing side, long rand) {
        ...
        Boolean north = extendedBlockState.getValue(BlockPipeEnergy.NORTH_CONNECTION);
        Boolean south = extendedBlockState.getValue(BlockPipeEnergy.SOUTH_CONNECTION);
        Boolean west = extendedBlockState.getValue(BlockPipeEnergy.WEST_CONNECTION);
        Boolean east = extendedBlockState.getValue(BlockPipeEnergy.EAST_CONNECTION);
        Boolean up = extendedBlockState.getValue(BlockPipeEnergy.UP_CONNECTION);
        Boolean down = extendedBlockState.getValue(BlockPipeEnergy.DOWN_CONNECTION);
